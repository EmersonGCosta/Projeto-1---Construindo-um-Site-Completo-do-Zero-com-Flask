...
from sitecurso import app, database, bcrypt
from sitecurso.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
...
def login():
    ...
    if form_login.validate_on_submit() and  "botao_submit_login" in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, form_login.senha.data):
            ...
            #direcionar para a página selecionada antes de ter feito o login
...
def editar_perfil():
    ...
    if  form.validate_on_submit():
        ...
        database.session.commit()
        flash(f"Perfil atualizado com sucesso para o E-mail ", 'alert-success')
